...
public class XAWorker extends HRDBMSThread
{
	...
	public XAWorker(final Plan p, final Transaction tx, final boolean result)
	{
	...
	public void run()
	{
		for (final Operator tree : p.getTrees())
		{
			try
			{
