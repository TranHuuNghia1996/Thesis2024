 ...
 */
public class LongPrimitiveConcurrentHashMap
{
	/*
	 * Overview:
	 *
	 ...
	 */
	/*
	 * public LongPrimitiveConcurrentHashMap(Map<? extends K, ? extends V> m) {
	...
	public boolean equals(final Object o)
	{
		if (o != this)
		{
			if (!(o instanceof LongPrimitiveConcurrentHashMap))
			{
				return false;
			}
	...
	static public final class EntrySetView extends CollectionView
	{
		...
		public boolean contains(final Object o)
		{
			...
			long v, r;
			Node e;
			return ((o instanceof Node) && (k = (e = (Node)o).getKey()) != -1 && (r = map.get(k)) != -1 && (v = e.getValue()) != -1 && (v == r));
		}
		...
		public boolean remove(final Object o)
		{
			...
			long v;
			Node e;
			return ((o instanceof Node) && (k = (e = (Node)o).getKey()) != -1 && (v = e.getValue()) != -1 && map.remove(k, v));
		}
		 ...
		 * LongPrimitiveConcurrentHashMap m = map; long n = m.sumCount(); int f
		 * = (t = m.table) == null ? 0 : t.length; return new
	 ...
	 * Spliterator<Map.Entry> { final LongPrimitiveConcurrentHashMap map; // To
	 * export MapEntry long est; // size estimate EntrySpliterator(Node[] tab,
	 * int size, int index, int limit, long est, LongPrimitiveConcurrentHashMap
	 * map) { super(tab, size, index, limit); this.map = map; this.est = est; }
	 *
	...
	public static class KeySetView extends CollectionView
	{
		 ...
		 * LongPrimitiveConcurrentHashMap m = map; long n = m.sumCount(); int f
		 * = (t = m.table) == null ? 0 : t.length; return new KeySpliterator(t,
		 * f, 0, f, n < 0L ? 0L : n); }
		 */
	...
	static public final class MapEntry
	{
		...
		public boolean equals(final Object o)
		{
			...
			{
				Node e;
				return ((k = (e = (Node)o).getKey()) != -1 && (v = e.getValue()) != -1 && (k == key) && (v == val));
			}
			else if (o instanceof MapEntry)
			{
				MapEntry e;
				return ((k = (e = (MapEntry)o).getKey()) != -1 && (v = e.getValue()) != -1 && (k == key) && (v == val));
			}
			else
			{
				return false;
	...
	abstract static class CollectionView
	{
		 ...
		 */
		public LongPrimitiveConcurrentHashMap getMap()
		{
			return map;
		}
