 ...
 */
public class ReverseConcurrentHashMap
{
	/*
	 * Overview:
	 *
	 ...
	 * time. However, statistically, under random hash codes, this is not a
	 * common problem. Ideally, the frequency of nodes in bins follows a Poisson
	 ...
	 * nodes inspected per operation worst case) so ArrayList<Object> as keys
	 ...
	 * garbage collectable as soon as they are no ArrayList<Object>er referenced
	 * by any reader thread that may be in the midst of concurrently traversing
	 * table. Upon transfer, the old table bin contains only a special
	 ...
	 * final void compute() { final ToLongFunction<? super K> transformer; final
	 * LongBinaryOperator reducer; if ((transformer = this.transformer) != null
	 * && (reducer = this.reducer) != null) { ArrayList<Object> r = this.basis;
	 * for (int i = baseIndex, f, h; batch > 0 && (h = ((f = baseLimit) + i) >>>
	 * 1) > i;) { addToPendingCount(1); (rights = new
	 * MapReduceKeysToLongTask<K,V> (this, batch >>>= 1, baseLimit = h, f, tab,
	 * rights, transformer, r, reducer)).fork(); } for (Node<K,V> p; (p =
	 ...
	 * for (int i = baseIndex, f, h; batch > 0 && (h = ((f = baseLimit) + i) >>>
	 * 1) > i;) { addToPendingCount(1); (rights = new
	 * MapReduceValuesToLongTask<K,V> (this, batch >>>= 1, baseLimit = h, f,
	 * tab, rights, transformer, r, reducer)).fork(); } for (Node<K,V> p; (p =
	 * advance()) != null; ) r = reducer.applyAsLong(r,
	 ...
	 * final ToLongFunction<Map.Entry> transformer; final LongBinaryOperator
	 * reducer; if ((transformer = this.transformer) != null && (reducer =
	 * this.reducer) != null) { ArrayList<Object> r = this.basis; for (int i =
	 * baseIndex, f, h; batch > 0 && (h = ((f = baseLimit) + i) >>> 1) > i;) {
	 * addToPendingCount(1); (rights = new MapReduceEntriesToLongTask (this,
	 * batch >>>= 1, baseLimit = h, f, tab, rights, transformer, r,
	 * reducer)).fork(); } for (Node p; (p = advance()) != null; ) r =
	 ...
	 * ((transformer = this.transformer) != null && (reducer = this.reducer) !=
	 * null) { ArrayList<Object> r = this.basis; for (int i = baseIndex, f, h;
	 * batch > 0 && (h = ((f = baseLimit) + i) >>> 1) > i;) {
	 * addToPendingCount(1); (rights = new MapReduceMappingsToLongTask<K,V>
	 * (this, batch >>>= 1, baseLimit = h, f, tab, rights, transformer, r,
	 ...
	 */
	public ReverseConcurrentHashMap()
	{
	}
	 ...
	 */
	/*
	 * public ReverseConcurrentHashMap(Map<? extends K, ? extends V> m) {
	...
	public boolean equals(final Object o)
	{
		if (o != this)
		{
			if (!(o instanceof ReverseConcurrentHashMap))
			{
				return false;
			}
	...
	public long get(final ArrayList<Object> key)
	{
		...
		if ((tab = table) != null && (n = tab.length) > 0 && (e = tabAt(tab, (n - 1) & h)) != null)
		{
			...
			{
				return (p = e.find(h, key)) != null ? p.val : -1;
			}
			while ((e = e.next) != null)
			{
	 ...
	 * p.hash, j = h & mask; if ((first = tabAt(tab, j)) == null) insertAtFront
	 * = true; else { K k = p.key; if (first.hash < 0) { TreeBin<K,V> t =
	...
	{
		KeySetView ks;
		return (ks = keySet) != null ? ks : (keySet = new KeySetView(this, -1));
	}
	 ...
	 */
	/*
	 * public Enumeration<long> elements() { Node[] t; int f = (t = table) ==
	 * null ? 0 : t.length; return new ValueIterator(t, f, 0, f, this); }
	 */
	...
	public boolean remove(final ArrayList<Object> key, final long value)
	{
		...
		return value != -1 && replaceNode(key, -1, value) != -1;
	}
	...
	public long replace(final ArrayList<Object> key, final long value)
	{
		...
		return replaceNode(key, value, -1);
		// }
		// catch(Throwable e)
		// {
		// HRDBMSWorker.logger.debug("", e);
	...
	public boolean replace(final ArrayList<Object> key, final long oldValue, final long newValue)
	{
		...
		return replaceNode(key, newValue, oldValue) != -1;
	}
	 ...
	 * Spliterator { ArrayList<Object> est; // size estimate
	...
	public static class KeySetView extends CollectionView
	{
		...
		/*
		 * public Spliterator spliterator() { Node[] t; ReverseConcurrentHashMap
		 * m = map; ArrayList<Object> n = m.sumCount(); int f = (t = m.table) ==
		 * null ? 0 : t.length; return new KeySpliterator(t, f, 0, f, n < 0L ?
		 * 0L : n); }
		 */
	 ...
	 * table, searchFunction, new AtomicReference<U>()).invoke(); }
	 */
	/**
	 ...
	 * null) throw new NullPointerException(); return new
	 * MapReduceMappingsTask<K,V,U> (null, batchFor(parallelismThreshold), 0, 0,
	 * table, null, transformer, reducer).invoke(); }
	 */
	/**
	 * Returns the result of accumulating the given transformation of all (key,
	 ...
	 * MapReduceMappingsToLongTask<K,V> (null, batchFor(parallelismThreshold),
	 * 0, 0, table, null, transformer, basis, reducer).invoke(); }
	 */
	/**
	 * Returns the result of accumulating the given transformation of all (key,
	 ...
	 * MapReduceMappingsToIntTask<K,V> (null, batchFor(parallelismThreshold), 0,
	 ...
	 * super U, ? extends U> reducer) { if (transformer == null || reducer ==
	 * null) throw new NullPointerException(); return new
	 * MapReduceKeysTask<K,V,U> (null, batchFor(parallelismThreshold), 0, 0,
	 * table, null, transformer, reducer).invoke(); }
	 */
	/**
	 * Returns the result of accumulating the given transformation of all keys
	 ...
	 * ArrayList<Object> basis, LongBinaryOperator reducer) { if (transformer ==
	 * null || reducer == null) throw new NullPointerException(); return new
	 * MapReduceKeysToLongTask<K,V> (null, batchFor(parallelismThreshold), 0, 0,
	 ...
	 * super U, ? extends U> reducer) { if (transformer == null || reducer ==
	 * null) throw new NullPointerException(); return new
	 * MapReduceValuesTask<K,V,U> (null, batchFor(parallelismThreshold), 0, 0,
	 * table, null, transformer, reducer).invoke(); }
	 */
	 ...
	 * ArrayList<Object> basis, LongBinaryOperator reducer) { if (transformer ==
	 * null || reducer == null) throw new NullPointerException(); return new
	 * MapReduceValuesToLongTask<K,V> (null, batchFor(parallelismThreshold), 0,
	 * 0, table, null, transformer, basis, reducer).invoke(); }
	 */
	 ...
	 * super U, ? extends U> reducer) { if (transformer == null || reducer ==
	 * null) throw new NullPointerException(); return new
	 * MapReduceEntriesTask<U> (null, batchFor(parallelismThreshold), 0, 0,
	 * table, null, transformer, reducer).invoke(); }
	 */
	 ...
	 * ArrayList<Object> basis, LongBinaryOperator reducer) { if (transformer ==
	 * null || reducer == null) throw new NullPointerException(); return new
	 * MapReduceEntriesToLongTask (null, batchFor(parallelismThreshold), 0, 0,
	 * table, null, transformer, basis, reducer).invoke(); }
	 */
	...
	static public final class MapEntry
	{
		...
		public boolean equals(final Object o)
		{
			...
			{
				Node e;
				return ((k = (e = (Node)o).getKey()) != null && (v = e.getValue()) != -1 && (k == key || key.equals(k)) && (v == val));
			}
			else if (o instanceof MapEntry)
			{
				MapEntry e;
				return ((k = (e = (MapEntry)o).getKey()) != null && (v = e.getValue()) != -1 && (k == key || key.equals(k)) && (v == val));
			}
			else
			{
				return false;
	...
	static public final class ValuesView extends CollectionView
	{
		...
		/*
		 * public final boolean remove(Object o) { if (o != null) { for
		 * (Iterator<long> it = iterator(); it.hasNext();) { if
		 * (o.equals(it.next())) { it.remove(); return true; } } } return false;
		 * }
		 */
		...
		/*
		 * public Spliterator<long> spliterator() { Node[] t;
		 * ReverseConcurrentHashMap m = map; ArrayList<Object> n = m.sumCount();
		 * int f = (t = m.table) == null ? 0 : t.length; return new
		 * ValueSpliterator(t, f, 0, f, n < 0L ? 0L : n); }
		 */
	...
	abstract static class CollectionView
	{
		 ...
		 */
		public ReverseConcurrentHashMap getMap()
		{
			return map;
		}
		...
		/*
		 * public final Object[] toArray() { ArrayList<Object> sz =
		 * map.mappingCount(); if (sz > MAX_ARRAY_SIZE) throw new
		 * OutOfMemoryError(oomeMsg); int n = (int)sz; Object[] r = new
		 * Object[n]; int i = 0; for (E e : this) { if (i == n) { if (n >=
		 * MAX_ARRAY_SIZE) throw new OutOfMemoryError(oomeMsg); if (n >=
		 * MAX_ARRAY_SIZE - (MAX_ARRAY_SIZE >>> 1) - 1) n = MAX_ARRAY_SIZE; else
		 * n += (n >>> 1) + 1; r = Arrays.copyOf(r, n); } r[i++] = e; } return
		 * (i == n) ? r : Arrays.copyOf(r, i); }
		 */

		/*
		 * @SuppressWarnings("unchecked") public final <T> T[] toArray(T[] a) {
		 * ArrayList<Object> sz = map.mappingCount(); if (sz > MAX_ARRAY_SIZE)
		 * throw new OutOfMemoryError(oomeMsg); int m = (int)sz; T[] r =
		 * (a.length >= m) ? a : (T[])java.lang.reflect.Array
