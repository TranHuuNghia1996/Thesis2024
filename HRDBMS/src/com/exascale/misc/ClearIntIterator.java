...
/**
 * This class is equivalent to IntIteratorImpl, except that it allows use to
 * iterate over "clear" bits (bits set to 0).
 *
...
final class ClearIntIterator implements IntIterator
{
	...
	ClearIntIterator(final EWAHIterator ewahIter, final int sizeInBits)
	{
